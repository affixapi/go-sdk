...
// Employee20230301ResponseGroups struct for Employee20230301ResponseGroups
type Employee20230301ResponseGroups struct {
...
func NewEmployee20230301ResponseGroups(name NullableString, type_ NullableString) *Employee20230301ResponseGroups {
	this := Employee20230301ResponseGroups{}
	this.Name = name
	this.Type = type_
	return &this
}
...
func (o Employee20230301ResponseGroups) MarshalJSON() ([]byte, error) {
...
type NullableEmployee20230301ResponseGroups struct {
	value *Employee20230301ResponseGroups
	isSet bool
}

func (v NullableEmployee20230301ResponseGroups) Get() *Employee20230301ResponseGroups {
	return v.value
}

func (v *NullableEmployee20230301ResponseGroups) Set(val *Employee20230301ResponseGroups) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployee20230301ResponseGroups) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployee20230301ResponseGroups) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployee20230301ResponseGroups(val *Employee20230301ResponseGroups) *NullableEmployee20230301ResponseGroups {
	return &NullableEmployee20230301ResponseGroups{value: val, isSet: true}
}

func (v NullableEmployee20230301ResponseGroups) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployee20230301ResponseGroups) UnmarshalJSON(src []byte) error {
	v.isSet = true
