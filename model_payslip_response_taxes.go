...
// GetEmployerTax returns the EmployerTax field value
...
// GetEmployerTaxOk returns a tuple with the EmployerTax field value
// and a boolean to check if the value has been set.
...
func NewNullablePayslipResponseTaxes(val *PayslipResponseTaxes) *NullablePayslipResponseTaxes {
	return &NullablePayslipResponseTaxes{value: val, isSet: true}
}
