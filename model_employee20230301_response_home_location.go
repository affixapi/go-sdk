...
// Employee20230301ResponseHomeLocation struct for Employee20230301ResponseHomeLocation
type Employee20230301ResponseHomeLocation struct {
...
func NewEmployee20230301ResponseHomeLocation(location LocationResponse) *Employee20230301ResponseHomeLocation {
	this := Employee20230301ResponseHomeLocation{}
...
func (o Employee20230301ResponseHomeLocation) MarshalJSON() ([]byte, error) {
...
type NullableEmployee20230301ResponseHomeLocation struct {
	value *Employee20230301ResponseHomeLocation
	isSet bool
}

func (v NullableEmployee20230301ResponseHomeLocation) Get() *Employee20230301ResponseHomeLocation {
	return v.value
}

func (v *NullableEmployee20230301ResponseHomeLocation) Set(val *Employee20230301ResponseHomeLocation) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployee20230301ResponseHomeLocation) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployee20230301ResponseHomeLocation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployee20230301ResponseHomeLocation(val *Employee20230301ResponseHomeLocation) *NullableEmployee20230301ResponseHomeLocation {
	return &NullableEmployee20230301ResponseHomeLocation{value: val, isSet: true}
}

func (v NullableEmployee20230301ResponseHomeLocation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployee20230301ResponseHomeLocation) UnmarshalJSON(src []byte) error {
	v.isSet = true
