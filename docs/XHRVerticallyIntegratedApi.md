...
func main() {
    employmentStatus := openapiclient.employment-status("null") // EmploymentStatus | Enable server-side filtering of the `employment_status` attribute  (optional)
...
------------- | ------------- | ------------- | -------------
 **employmentStatus** | [**EmploymentStatus**](EmploymentStatus.md) | Enable server-side filtering of the &#x60;employment_status&#x60; attribute  | 
