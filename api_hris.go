...
// HrisApiService HrisApi service
type HrisApiService service

type ApiHrisEmployees20230301Request struct {
	ctx _context.Context
	ApiService *HrisApiService
}
 ...
 */
func (a *HrisApiService) HrisEmployees20230301(ctx _context.Context) ApiHrisEmployees20230301Request {
	return ApiHrisEmployees20230301Request{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *HrisApiService) HrisEmployees20230301Execute(r ApiHrisEmployees20230301Request) ([]Employee20230301Response, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "HrisApiService.HrisEmployees20230301")
	if err != nil {
 ...
 */
func (a *HrisApiService) HrisIdentity20230301(ctx _context.Context) ApiHrisIdentity20230301Request {
	return ApiHrisIdentity20230301Request{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *HrisApiService) HrisIdentity20230301Execute(r ApiHrisIdentity20230301Request) (IdentityResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "HrisApiService.HrisIdentity20230301")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
