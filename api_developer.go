 ...
 */
func (a *DeveloperApiService) DeveloperPayslips20230320(ctx _context.Context, payrunId string) ApiDeveloperPayslips20230320Request {
	return ApiDeveloperPayslips20230320Request{
		ApiService: a,
		ctx: ctx,
		payrunId: payrunId,
 ...
 */
func (a *DeveloperApiService) DeveloperPayslips20230320Execute(r ApiDeveloperPayslips20230320Request) ([]PayslipResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DeveloperApiService.DeveloperPayslips20230320")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
