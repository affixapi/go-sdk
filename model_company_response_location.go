...
// CompanyResponseLocation struct for CompanyResponseLocation
type CompanyResponseLocation struct {
...
func (o CompanyResponseLocation) MarshalJSON() ([]byte, error) {
...
type NullableCompanyResponseLocation struct {
	value *CompanyResponseLocation
	isSet bool
}

func (v NullableCompanyResponseLocation) Get() *CompanyResponseLocation {
	return v.value
}

func (v *NullableCompanyResponseLocation) Set(val *CompanyResponseLocation) {
	v.value = val
	v.isSet = true
}

func (v NullableCompanyResponseLocation) IsSet() bool {
	return v.isSet
}

func (v *NullableCompanyResponseLocation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCompanyResponseLocation(val *CompanyResponseLocation) *NullableCompanyResponseLocation {
	return &NullableCompanyResponseLocation{value: val, isSet: true}
}

func (v NullableCompanyResponseLocation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCompanyResponseLocation) UnmarshalJSON(src []byte) error {
	v.isSet = true
