...
type ApiHrisEmployees20230301Request struct {
	ctx _context.Context
	ApiService *Class20230301ApiService
}


func (r ApiHrisEmployees20230301Request) Execute() ([]Employee20230301Response, *_nethttp.Response, error) {
	return r.ApiService.HrisEmployees20230301Execute(r)
}

/*
 * HrisEmployees20230301 Employees
 ...
 * @return ApiHrisEmployees20230301Request
 */
func (a *Class20230301ApiService) HrisEmployees20230301(ctx _context.Context) ApiHrisEmployees20230301Request {
	return ApiHrisEmployees20230301Request{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *Class20230301ApiService) HrisEmployees20230301Execute(r ApiHrisEmployees20230301Request) ([]Employee20230301Response, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class20230301ApiService.HrisEmployees20230301")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/2023-03-01/hris/employees"
...
type ApiHrisIdentity20230301Request struct {
	ctx _context.Context
	ApiService *Class20230301ApiService
}


func (r ApiHrisIdentity20230301Request) Execute() (IdentityResponse, *_nethttp.Response, error) {
	return r.ApiService.HrisIdentity20230301Execute(r)
}

/*
 * HrisIdentity20230301 Identity
 * List information of the user for the respective account

 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiHrisIdentity20230301Request
 */
func (a *Class20230301ApiService) HrisIdentity20230301(ctx _context.Context) ApiHrisIdentity20230301Request {
	return ApiHrisIdentity20230301Request{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *Class20230301ApiService) HrisIdentity20230301Execute(r ApiHrisIdentity20230301Request) (IdentityResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class20230301ApiService.HrisIdentity20230301")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/2023-03-01/hris/identity"
 ...
 */
func (a *Class20230301ApiService) PayrollEmployees20230301(ctx _context.Context) ApiPayrollEmployees20230301Request {
	return ApiPayrollEmployees20230301Request{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return []Employee20230301Response
 */
func (a *Class20230301ApiService) PayrollEmployees20230301Execute(r ApiPayrollEmployees20230301Request) ([]Employee20230301Response, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class20230301ApiService.PayrollEmployees20230301")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
 ...
 */
func (a *Class20230301ApiService) PayrollIdentity20230301(ctx _context.Context) ApiPayrollIdentity20230301Request {
	return ApiPayrollIdentity20230301Request{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return IdentityResponse
 */
func (a *Class20230301ApiService) PayrollIdentity20230301Execute(r ApiPayrollIdentity20230301Request) (IdentityResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class20230301ApiService.PayrollIdentity20230301")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
 ...
 */
func (a *Class20230301ApiService) PayrollPayruns20230301(ctx _context.Context) ApiPayrollPayruns20230301Request {
	return ApiPayrollPayruns20230301Request{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *Class20230301ApiService) PayrollPayruns20230301Execute(r ApiPayrollPayruns20230301Request) ([]PayrunResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class20230301ApiService.PayrollPayruns20230301")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
 ...
 */
func (a *Class20230301ApiService) PayrollPayslips20230320(ctx _context.Context, payrunId string) ApiPayrollPayslips20230320Request {
	return ApiPayrollPayslips20230320Request{
		ApiService: a,
		ctx: ctx,
		payrunId: payrunId,
 ...
 */
func (a *Class20230301ApiService) PayrollPayslips20230320Execute(r ApiPayrollPayslips20230320Request) ([]PayslipResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class20230301ApiService.PayrollPayslips20230320")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
