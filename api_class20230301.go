...
func (r ApiXhrCompanies20230301Request) Execute() ([]CompanyResponse, *_nethttp.Response, error) {
	return r.ApiService.XhrCompanies20230301Execute(r)
}

/*
 * XhrCompanies20230301 Company
 * Retrieve company information

 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiXhrCompanies20230301Request
 */
...
func (a *Class20230301ApiService) XhrCompanies20230301Execute(r ApiXhrCompanies20230301Request) ([]CompanyResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class20230301ApiService.XhrCompanies20230301")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/2023-03-01/xhr/company"
...
type ApiXhrCreateEmployee20230301Request struct {
	ctx _context.Context
	ApiService *Class20230301ApiService
	createEmployeeRequest *CreateEmployeeRequest
}

func (r ApiXhrCreateEmployee20230301Request) CreateEmployeeRequest(createEmployeeRequest CreateEmployeeRequest) ApiXhrCreateEmployee20230301Request {
	r.createEmployeeRequest = &createEmployeeRequest
	return r
}

func (r ApiXhrCreateEmployee20230301Request) Execute() (EmployeeResponse, *_nethttp.Response, error) {
	return r.ApiService.XhrCreateEmployee20230301Execute(r)
}

/*
 * XhrCreateEmployee20230301 Create employee
 * Creates a new Employee

 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiXhrCreateEmployee20230301Request
 */
func (a *Class20230301ApiService) XhrCreateEmployee20230301(ctx _context.Context) ApiXhrCreateEmployee20230301Request {
	return ApiXhrCreateEmployee20230301Request{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return EmployeeResponse
 */
func (a *Class20230301ApiService) XhrCreateEmployee20230301Execute(r ApiXhrCreateEmployee20230301Request) (EmployeeResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class20230301ApiService.XhrCreateEmployee20230301")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/2023-03-01/xhr/employee"
...
func (a *Class20230301ApiService) XhrEmployees20230301Execute(r ApiXhrEmployees20230301Request) ([]EmployeeResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class20230301ApiService.XhrEmployees20230301")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/2023-03-01/xhr/employees"
...
func (r ApiXhrGroups20230301Request) Execute() ([]GroupResponse, *_nethttp.Response, error) {
	return r.ApiService.XhrGroups20230301Execute(r)
}
...
func (a *Class20230301ApiService) XhrGroups20230301Execute(r ApiXhrGroups20230301Request) ([]GroupResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class20230301ApiService.XhrGroups20230301")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/2023-03-01/xhr/groups"
...
func (r ApiXhrIdentity20230301Request) Execute() (IdentityResponse, *_nethttp.Response, error) {
	return r.ApiService.XhrIdentity20230301Execute(r)
}

/*
 * XhrIdentity20230301 Identity
 * List information of the user for the respective account

 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiXhrIdentity20230301Request
 */
...
func (a *Class20230301ApiService) XhrIdentity20230301Execute(r ApiXhrIdentity20230301Request) (IdentityResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class20230301ApiService.XhrIdentity20230301")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/2023-03-01/xhr/identity"
...
func (r ApiXhrPayruns20230301Request) Execute() ([]PayrunResponse, *_nethttp.Response, error) {
	return r.ApiService.XhrPayruns20230301Execute(r)
}
...
func (a *Class20230301ApiService) XhrPayruns20230301Execute(r ApiXhrPayruns20230301Request) ([]PayrunResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class20230301ApiService.XhrPayruns20230301")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/2023-03-01/xhr/payruns"
...
func (r ApiXhrPayslips20230301Request) Execute() ([]PayslipResponse, *_nethttp.Response, error) {
	return r.ApiService.XhrPayslips20230301Execute(r)
}
...
func (a *Class20230301ApiService) XhrPayslips20230301Execute(r ApiXhrPayslips20230301Request) ([]PayslipResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class20230301ApiService.XhrPayslips20230301")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/2023-03-01/xhr/payruns/{payrun_id}"
...
func (r ApiXhrTimeOffBalances20230301Request) Execute() ([]TimeOffBalanceResponse, *_nethttp.Response, error) {
	return r.ApiService.XhrTimeOffBalances20230301Execute(r)
}

/*
 * XhrTimeOffBalances20230301 Time off balances
 * Retrieve all time off balances.

 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiXhrTimeOffBalances20230301Request
 */
...
func (a *Class20230301ApiService) XhrTimeOffBalances20230301Execute(r ApiXhrTimeOffBalances20230301Request) ([]TimeOffBalanceResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class20230301ApiService.XhrTimeOffBalances20230301")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/2023-03-01/xhr/time-off-balances"
...
/*
 * XhrTimeOffEntries20230301 Time off entries
 * Retrieve time off / absence entries

 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiXhrTimeOffEntries20230301Request
 */
...
func (a *Class20230301ApiService) XhrTimeOffEntries20230301Execute(r ApiXhrTimeOffEntries20230301Request) ([]TimeOffEntryResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class20230301ApiService.XhrTimeOffEntries20230301")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/2023-03-01/xhr/time-off-entries"
...
/*
 * XhrTimesheets20230301 Timesheets
 * Retrieve Timesheets

 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiXhrTimesheets20230301Request
 */
...
func (a *Class20230301ApiService) XhrTimesheets20230301Execute(r ApiXhrTimesheets20230301Request) ([]TimesheetResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class20230301ApiService.XhrTimesheets20230301")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/2023-03-01/xhr/timesheets"
...
func (r ApiXhrWorkLocations20230301Request) Execute() ([]LocationResponse, *_nethttp.Response, error) {
	return r.ApiService.XhrWorkLocations20230301Execute(r)
}
...
func (a *Class20230301ApiService) XhrWorkLocations20230301Execute(r ApiXhrWorkLocations20230301Request) ([]LocationResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class20230301ApiService.XhrWorkLocations20230301")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/2023-03-01/xhr/work-locations"
