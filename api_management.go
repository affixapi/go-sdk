...
func (r ApiClientRequest) Execute() (ClientResponse, *_nethttp.Response, error) {
	return r.ApiService.ClientExecute(r)
}
...
func (a *ManagementApiService) ClientExecute(r ApiClientRequest) (ClientResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ManagementApiService.Client")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/2023-03-01/management/client"
...
func (a *ManagementApiService) DisconnectExecute(r ApiDisconnectRequest) (DisconnectResponse, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  DisconnectResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ManagementApiService.Disconnect")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/2023-03-01/management/disconnect"
...
func (a *ManagementApiService) IntrospectExecute(r ApiIntrospectRequest) (IntrospectResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ManagementApiService.Introspect")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/2023-03-01/management/introspect"
...
/*
 * Token Exchange `authorization_code` for `access_token`
...
func (a *ManagementApiService) TokenExecute(r ApiTokenRequest) (TokenResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ManagementApiService.Token")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/2023-03-01/management/token"
...
func (a *ManagementApiService) TokensExecute(r ApiTokensRequest) ([]map[string]interface{}, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ManagementApiService.Tokens")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/2023-03-01/management/tokens"
...
func (a *ManagementApiService) UpdateClientExecute(r ApiUpdateClientRequest) (ClientResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ManagementApiService.UpdateClient")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
