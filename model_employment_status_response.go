...
var allowedEmploymentStatusResponseEnumValues = []EmploymentStatusResponse{
	"null",
	"active",
	"inactive",
	"pending",
...
func (v *EmploymentStatusResponse) UnmarshalJSON(src []byte) error {
	...
	enumTypeValue := EmploymentStatusResponse(value)
	for _, existing := range allowedEmploymentStatusResponseEnumValues {
	...
	return fmt.Errorf("%+v is not a valid EmploymentStatusResponse", value)
}

// NewEmploymentStatusResponseFromValue returns a pointer to a valid EmploymentStatusResponse
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewEmploymentStatusResponseFromValue(v string) (*EmploymentStatusResponse, error) {
	ev := EmploymentStatusResponse(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for EmploymentStatusResponse: valid values are %v", v, allowedEmploymentStatusResponseEnumValues)
	}
}
...
type NullableEmploymentStatusResponse struct {
	value *EmploymentStatusResponse
	isSet bool
}
...
func NewNullableEmploymentStatusResponse(val *EmploymentStatusResponse) *NullableEmploymentStatusResponse {
	return &NullableEmploymentStatusResponse{value: val, isSet: true}
}
