...
func (o *ClientResponse) GetWebhookUri() string {
	if o == nil || o.WebhookUri.Get() == nil {
		var ret string
		return ret
	}
	return *o.WebhookUri.Get()
}
...
func (o ClientResponse) MarshalJSON() ([]byte, error) {
	...
	if o.WebhookUri.IsSet() {
		toSerialize["webhook_uri"] = o.WebhookUri.Get()
	}
