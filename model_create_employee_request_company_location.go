...
// CreateEmployeeRequestCompanyLocation struct for CreateEmployeeRequestCompanyLocation
type CreateEmployeeRequestCompanyLocation struct {
...
func NewCreateEmployeeRequestCompanyLocation(streetAddress NullableString, locality NullableString, administrativeArea NullableString, country NullableString, postCode NullableString) *CreateEmployeeRequestCompanyLocation {
	this := CreateEmployeeRequestCompanyLocation{}
...
func (o *CreateEmployeeRequestCompanyLocation) SetStreetAddress(v string) {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CreateEmployeeRequestCompanyLocation) GetPostCodeOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
...
func (o CreateEmployeeRequestCompanyLocation) MarshalJSON() ([]byte, error) {
...
type NullableCreateEmployeeRequestCompanyLocation struct {
	value *CreateEmployeeRequestCompanyLocation
	isSet bool
}

func (v NullableCreateEmployeeRequestCompanyLocation) Get() *CreateEmployeeRequestCompanyLocation {
	return v.value
}

func (v *NullableCreateEmployeeRequestCompanyLocation) Set(val *CreateEmployeeRequestCompanyLocation) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateEmployeeRequestCompanyLocation) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateEmployeeRequestCompanyLocation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateEmployeeRequestCompanyLocation(val *CreateEmployeeRequestCompanyLocation) *NullableCreateEmployeeRequestCompanyLocation {
	return &NullableCreateEmployeeRequestCompanyLocation{value: val, isSet: true}
}

func (v NullableCreateEmployeeRequestCompanyLocation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateEmployeeRequestCompanyLocation) UnmarshalJSON(src []byte) error {
	v.isSet = true
