...
func (a *XHRVerticallyIntegratedApiService) XhrCompanies20230301Execute(r ApiXhrCompanies20230301Request) ([]CompanyResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "XHRVerticallyIntegratedApiService.XhrCompanies20230301")
	if err != nil {
 ...
 */
func (a *XHRVerticallyIntegratedApiService) XhrCreateEmployee20230301(ctx _context.Context) ApiXhrCreateEmployee20230301Request {
	return ApiXhrCreateEmployee20230301Request{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *XHRVerticallyIntegratedApiService) XhrCreateEmployee20230301Execute(r ApiXhrCreateEmployee20230301Request) (EmployeeResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "XHRVerticallyIntegratedApiService.XhrCreateEmployee20230301")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (a *XHRVerticallyIntegratedApiService) XhrEmployees20230301Execute(r ApiXhrEmployees20230301Request) ([]EmployeeResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "XHRVerticallyIntegratedApiService.XhrEmployees20230301")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (a *XHRVerticallyIntegratedApiService) XhrGroups20230301Execute(r ApiXhrGroups20230301Request) ([]GroupResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "XHRVerticallyIntegratedApiService.XhrGroups20230301")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (a *XHRVerticallyIntegratedApiService) XhrIdentity20230301Execute(r ApiXhrIdentity20230301Request) (IdentityResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "XHRVerticallyIntegratedApiService.XhrIdentity20230301")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (a *XHRVerticallyIntegratedApiService) XhrPayruns20230301Execute(r ApiXhrPayruns20230301Request) ([]PayrunResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "XHRVerticallyIntegratedApiService.XhrPayruns20230301")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (a *XHRVerticallyIntegratedApiService) XhrPayslips20230301Execute(r ApiXhrPayslips20230301Request) ([]PayslipResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "XHRVerticallyIntegratedApiService.XhrPayslips20230301")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (a *XHRVerticallyIntegratedApiService) XhrTimeOffBalances20230301Execute(r ApiXhrTimeOffBalances20230301Request) ([]TimeOffBalanceResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "XHRVerticallyIntegratedApiService.XhrTimeOffBalances20230301")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (a *XHRVerticallyIntegratedApiService) XhrTimeOffEntries20230301Execute(r ApiXhrTimeOffEntries20230301Request) ([]TimeOffEntryResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "XHRVerticallyIntegratedApiService.XhrTimeOffEntries20230301")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (a *XHRVerticallyIntegratedApiService) XhrTimesheets20230301Execute(r ApiXhrTimesheets20230301Request) ([]TimesheetResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "XHRVerticallyIntegratedApiService.XhrTimesheets20230301")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (a *XHRVerticallyIntegratedApiService) XhrWorkLocations20230301Execute(r ApiXhrWorkLocations20230301Request) ([]LocationResponse, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "XHRVerticallyIntegratedApiService.XhrWorkLocations20230301")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
