...
// PayslipResponseEarnings struct for PayslipResponseEarnings
...
func NewNullablePayslipResponseEarnings(val *PayslipResponseEarnings) *NullablePayslipResponseEarnings {
	return &NullablePayslipResponseEarnings{value: val, isSet: true}
}
