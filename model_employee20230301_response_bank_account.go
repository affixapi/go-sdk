...
// Employee20230301ResponseBankAccount struct for Employee20230301ResponseBankAccount
type Employee20230301ResponseBankAccount struct {
...
func NewEmployee20230301ResponseBankAccount(accountNumber NullableString, bankName NullableString, bic NullableString, holderName NullableString, iban NullableString) *Employee20230301ResponseBankAccount {
	this := Employee20230301ResponseBankAccount{}
...
func (o Employee20230301ResponseBankAccount) MarshalJSON() ([]byte, error) {
...
type NullableEmployee20230301ResponseBankAccount struct {
	value *Employee20230301ResponseBankAccount
	isSet bool
}

func (v NullableEmployee20230301ResponseBankAccount) Get() *Employee20230301ResponseBankAccount {
	return v.value
}

func (v *NullableEmployee20230301ResponseBankAccount) Set(val *Employee20230301ResponseBankAccount) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployee20230301ResponseBankAccount) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployee20230301ResponseBankAccount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployee20230301ResponseBankAccount(val *Employee20230301ResponseBankAccount) *NullableEmployee20230301ResponseBankAccount {
	return &NullableEmployee20230301ResponseBankAccount{value: val, isSet: true}
}

func (v NullableEmployee20230301ResponseBankAccount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployee20230301ResponseBankAccount) UnmarshalJSON(src []byte) error {
	v.isSet = true
