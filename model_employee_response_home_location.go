...
// EmployeeResponseHomeLocation struct for EmployeeResponseHomeLocation
type EmployeeResponseHomeLocation struct {
...
func NewEmployeeResponseHomeLocation(location LocationResponse) *EmployeeResponseHomeLocation {
	this := EmployeeResponseHomeLocation{}
...
func (o EmployeeResponseHomeLocation) MarshalJSON() ([]byte, error) {
...
type NullableEmployeeResponseHomeLocation struct {
	value *EmployeeResponseHomeLocation
	isSet bool
}

func (v NullableEmployeeResponseHomeLocation) Get() *EmployeeResponseHomeLocation {
	return v.value
}

func (v *NullableEmployeeResponseHomeLocation) Set(val *EmployeeResponseHomeLocation) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployeeResponseHomeLocation) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployeeResponseHomeLocation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployeeResponseHomeLocation(val *EmployeeResponseHomeLocation) *NullableEmployeeResponseHomeLocation {
	return &NullableEmployeeResponseHomeLocation{value: val, isSet: true}
}

func (v NullableEmployeeResponseHomeLocation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployeeResponseHomeLocation) UnmarshalJSON(src []byte) error {
	v.isSet = true
