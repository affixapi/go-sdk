...
// CreateEmployeeRequestWorkLocation struct for CreateEmployeeRequestWorkLocation
type CreateEmployeeRequestWorkLocation struct {
...
func NewCreateEmployeeRequestWorkLocation(location LocationRequest, type_ NullableString, name NullableString) *CreateEmployeeRequestWorkLocation {
	this := CreateEmployeeRequestWorkLocation{}
...
func (o CreateEmployeeRequestWorkLocation) MarshalJSON() ([]byte, error) {
...
type NullableCreateEmployeeRequestWorkLocation struct {
	value *CreateEmployeeRequestWorkLocation
	isSet bool
}

func (v NullableCreateEmployeeRequestWorkLocation) Get() *CreateEmployeeRequestWorkLocation {
	return v.value
}

func (v *NullableCreateEmployeeRequestWorkLocation) Set(val *CreateEmployeeRequestWorkLocation) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateEmployeeRequestWorkLocation) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateEmployeeRequestWorkLocation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateEmployeeRequestWorkLocation(val *CreateEmployeeRequestWorkLocation) *NullableCreateEmployeeRequestWorkLocation {
	return &NullableCreateEmployeeRequestWorkLocation{value: val, isSet: true}
}

func (v NullableCreateEmployeeRequestWorkLocation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateEmployeeRequestWorkLocation) UnmarshalJSON(src []byte) error {
	v.isSet = true
