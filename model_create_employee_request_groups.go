...
// CreateEmployeeRequestGroups struct for CreateEmployeeRequestGroups
type CreateEmployeeRequestGroups struct {
...
func NewCreateEmployeeRequestGroups(name NullableString, type_ NullableString) *CreateEmployeeRequestGroups {
	this := CreateEmployeeRequestGroups{}
	this.Name = name
	this.Type = type_
	return &this
}
...
func (o CreateEmployeeRequestGroups) MarshalJSON() ([]byte, error) {
...
type NullableCreateEmployeeRequestGroups struct {
	value *CreateEmployeeRequestGroups
	isSet bool
}

func (v NullableCreateEmployeeRequestGroups) Get() *CreateEmployeeRequestGroups {
	return v.value
}

func (v *NullableCreateEmployeeRequestGroups) Set(val *CreateEmployeeRequestGroups) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateEmployeeRequestGroups) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateEmployeeRequestGroups) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateEmployeeRequestGroups(val *CreateEmployeeRequestGroups) *NullableCreateEmployeeRequestGroups {
	return &NullableCreateEmployeeRequestGroups{value: val, isSet: true}
}

func (v NullableCreateEmployeeRequestGroups) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateEmployeeRequestGroups) UnmarshalJSON(src []byte) error {
	v.isSet = true
