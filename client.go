...
// APIClient manages communication with the Affix API API v2023-03-01
...
type APIClient struct {
	...
	Class20230320Api *Class20230320ApiService

	CoreApi *CoreApiService

	DeveloperApi *DeveloperApiService

	ManagementApi *ManagementApiService

	OfficialApi *OfficialApiService

	RawApi *RawApiService

	RetailApi *RetailApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.Class20230301Api = (*Class20230301ApiService)(&c.common)
	c.Class20230320Api = (*Class20230320ApiService)(&c.common)
	...
	c.OfficialApi = (*OfficialApiService)(&c.common)
	c.RawApi = (*RawApiService)(&c.common)
	c.RetailApi = (*RetailApiService)(&c.common)
