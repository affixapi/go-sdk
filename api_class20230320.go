...
// Class20230320ApiService Class20230320Api service
type Class20230320ApiService service

type ApiGetOrder20230320Request struct {
	ctx _context.Context
	ApiService *Class20230320ApiService
	orderId string
}
 ...
 */
func (a *Class20230320ApiService) GetOrder20230320(ctx _context.Context, orderId string) ApiGetOrder20230320Request {
	return ApiGetOrder20230320Request{
		ApiService: a,
		ctx: ctx,
		orderId: orderId,
 ...
 */
func (a *Class20230320ApiService) GetOrder20230320Execute(r ApiGetOrder20230320Request) (Order20230320Response, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class20230320ApiService.GetOrder20230320")
	if err != nil {
 ...
 */
func (a *Class20230320ApiService) Identity20230320(ctx _context.Context) ApiIdentity20230320Request {
	return ApiIdentity20230320Request{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *Class20230320ApiService) Identity20230320Execute(r ApiIdentity20230320Request) (IdentityResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class20230320ApiService.Identity20230320")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
 ...
 */
func (a *Class20230320ApiService) Orders20230320(ctx _context.Context) ApiOrders20230320Request {
	return ApiOrders20230320Request{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *Class20230320ApiService) Orders20230320Execute(r ApiOrders20230320Request) ([]map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "Class20230320ApiService.Orders20230320")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
